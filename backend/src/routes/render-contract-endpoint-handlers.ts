...
import { RENDER_CONTRACT_ENDPOINTS, type RenderContractEndpointKey } from './render-contract-endpoint-registry';
...
export const RENDER_CONTRACT_ENDPOINT_HANDLERS: Readonly<Record<RenderContractEndpointKey, RenderContractEndpointHandler>> =
  validateAndFreezeRouteHandlers({
    label: 'render contract endpoint',
    descriptors: RENDER_CONTRACT_ENDPOINTS,
    handlers: {
