...
test('runtime admin routes consume acceleration snapshots explicitly', () => {
  ...
  assert.match(runtimeAdminRoutes, /getAccelerationReconcileConflict\(accelerationSnapshot\)/);
  assert.match(runtimeAdminRoutes, /getAccelerationManagerUnavailableError\(\)/);
  assert.match(runtimeAdminRoutes, /getAccelerationReconcileAccepted\(getAccelerationRuntimeSnapshot\(\)\)/);
  assert.match(runtimeAdminRoutes, /getAccelerationReconcileFailureTransition\(label, error\)/);
