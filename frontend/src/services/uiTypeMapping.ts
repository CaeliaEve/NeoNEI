...
const FAMILY_KEY_TO_UI_TYPE: Record<string, string> = {
  avaritia: AVARITIA_EXTREME_CRAFTING.uiType,
  'crafting-table': STANDARD_CRAFTING.uiType,
  'crafting-table|crafting-grid|166x66@0#5|unknown': STANDARD_CRAFTING.uiType,
  'crafting-table|crafting-grid|166x140@0#2|unknown': THAUMCRAFT_ARCANE.uiType,
  'crafting-table|crafting-grid|256x208@0#1|unknown': AVARITIA_EXTREME_CRAFTING.uiType,
  minecraft: STANDARD_CRAFTING.uiType,
  timeconqueror: THAUMCRAFT_ARCANE.uiType,
  etfuturum: FURNACE.uiType,
  botania_terra_plate: BOTANIA_TERRA_PLATE.uiType,
  botania_rune_altar: BOTANIA_RUNE_ALTAR.uiType,
  'botania|native-nei|152x122@0#4|unknown': BOTANIA_RUNE_ALTAR.uiType,
  ...
  'thaumcraft|native-nei|166x140@0#2|unknown': THAUMCRAFT_ASPECT.uiType,
  'thaumcraft|native-nei|166x130@0#2|unknown': THAUMCRAFT_ASPECT.uiType,
