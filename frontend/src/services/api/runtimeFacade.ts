...
import { elysiumFacade } from './elysiumFacade';
...
export const api = {
  ...
  async getHomeBootstrap(params: {
    ...
    return elysiumFacade.getHomeBootstrap(params);
  },
  ...
  async getBrowserItems(params: {
    ...
    return elysiumFacade.getBrowserPagePack(params);
  },
  ...
  async getBrowserDefaultCatalog(params?: {
    ...
    return elysiumFacade.getBrowserDefaultCatalog(params);
  },
  ...
  async getBrowserSearchCatalog(params: {
    ...
    return elysiumFacade.getBrowserSearchCatalog(params);
  },
  ...
  async getBrowserGroupItems(groupKey: string, modId?: string, includeHidden = false): Promise<BrowserGroupItemsResponse> {
    return elysiumFacade.getBrowserGroupItems(groupKey, modId, includeHidden);
  },
  ...
  async primeDefaultBrowserPagePack(params: {
    ...
    return elysiumFacade.primeDefaultBrowserPagePack(params);
  },

  async getBrowserSearchPack(): Promise<BrowserSearchPackResponse> {
    return elysiumFacade.getBrowserSearchPack();
  },

  async getBrowserSearchPackShard(shardId: string): Promise<BrowserSearchPackResponse | null> {
    return elysiumFacade.getBrowserSearchPackShard(shardId);
  },
  ...
  async getBrowserPagePackByIds(params: {
    ...
    return elysiumFacade.getBrowserPagePackByIds(params);
  },
  ...
  async getOptionalRecipeUiPayload(recipeId: string): Promise<RecipeUiPayload | null> {
    return elysiumFacade.getOptionalRecipeUiPayload(recipeId);
  },
  ...
  async getRecipeBootstrapShard(itemId: string): Promise<RecipeBootstrapPayload> {
    return elysiumFacade.getRecipeBootstrapShard(itemId);
  },
  ...
  async getRecipeBootstrapProducedByGroup(
    ...
    return elysiumFacade.getRecipeBootstrapProducedByGroup(itemId, machineType, voltageTier, options);
  },
  ...
  async getRecipeBootstrapUsedInGroup(
    ...
    return elysiumFacade.getRecipeBootstrapUsedInGroup(itemId, machineType, voltageTier, options);
  },
  ...
  async getRecipeBootstrapCategoryGroup(
    ...
    return elysiumFacade.getRecipeBootstrapCategoryGroup(itemId, tab, categoryKey, options);
  },
  ...
  async getRecipeBootstrapSearch(
    ...
    return elysiumFacade.getRecipeBootstrapSearch(itemId, tab, query, options);
  },
  ...
  async getCurrentRecipePage(recipePageId: string, options?: SearchItemsFastOptions): Promise<CurrentRecipePageResponse> {
    return elysiumFacade.getCurrentRecipePage(recipePageId, options);
  },
  ...
  async getIndexedRecipesByIds(recipeIds: string[], options?: SearchItemsFastOptions): Promise<indexedRecipe[]> {
    ...
    return elysiumFacade.getIndexedRecipesByIds(uniqueIds, options);
  },

  async searchItemsFast(keyword: string, limit: number = 60, options?: SearchItemsFastOptions): Promise<ItemSearchBasic[]> {
    return elysiumFacade.searchItemsFast(keyword, limit, options);
  },
