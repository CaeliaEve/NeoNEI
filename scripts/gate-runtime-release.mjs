...
const steps = [
  ...
  { name: 'server bootstrap boundary regression', cwd: backendDir, command: node, args: ['--test', 'scripts/server-bootstrap-boundary-regression.test.mjs'] },
  { name: 'publish compression sidecar regression', cwd: backendDir, command: npm, args: ['run', 'test:publish-compression-sidecar'] },
  { name: 'path audit regression', cwd: repoRoot, command: node, args: ['--test', 'scripts/path-audit-regression.test.mjs'] },
  ...
  { name: 'native history surface gate', cwd: frontendDir, command: npm, args: ['run', 'test:native-history-surface'] },
